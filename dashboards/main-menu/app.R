...
ui <- fluidPage(
  ...
  column(width = 5,
         br(),
         actionButton("demographic_employment", "Demographic Employment Dashboard", width = 350, onclick = "setTimeout(function(){window.close();},5000);"),
         actionButton("employment_time", "Employment by Time with SOAR", width = 350, onclick = "setTimeout(function(){window.close();},5000);"),
         actionButton("chemical_dependency", "Chemical Dependency", width = 350, onclick = "setTimeout(function(){window.close();},5000);"),
         actionButton("barrier", "Barrier Dashboard", width = 350, onclick = "setTimeout(function(){window.close();},5000);"),
         br(),br(),br(),
  actionButton(
    inputId = "bug_report",
    label = "Bug Report",
